...
// so the two cannot drift. The second line is the BASIC V2 nod and the
// free-memory count MEM would give. The hardware line
...
import { coldBoot, BASIC_READY, hardwareLine, freeLine } from '../lib/boot.mjs'
